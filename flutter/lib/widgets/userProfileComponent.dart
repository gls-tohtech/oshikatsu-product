        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              CircleAvatar(
                radius: 40,
                backgroundImage: NetworkImage(userProfile.dbProcessedMap[
                    UserTableColumn.ICON_IMAGE_URL.name]), // 仮の画像URL
              ),
              SizedBox(width: 10),
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    Text(userProfile.dbProcessedMap[UserTableColumn.NAME.name],
                        style: Theme.of(context).textTheme.headline6),
                    Text('@kanata', style: Theme.of(context).textTheme.caption),
                    Text(userProfile.dbProcessedMap[
                        UserTableColumn.USER_PROFILE_DETAIL.name]),
                  ],
                ),
              ),
            ],
