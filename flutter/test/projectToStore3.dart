...
void main() async {
  ...
  test("project-store", () async {
    ...
    var auth = UserAuthInfo(
      "oshiageProguctTestMail2@gmail.com", 
      "qwertyuiop"
    );
    ...
    final project = Project(
      ...
      hashtags: ["idol", "生誕祭"],
      thumbnailUrl: "https://firebasestorage.googleapis.com/v0/b/oshikatsu-dev-8bb0d.appspot.com/o/PROJECT_IMAGE_STORAGE%2FF2LDbpHbAAEidt6.jpg?alt=media&token=dc5b8fca-d9d4-492f-99d1-3f5b3053e1be", 
      moneyGoal: 80000,
      moneyDonated: 50000
    );
