...
void main() async {
  ...
  test("project-store", () async {
    ...
    var auth = UserAuthInfo(
      "oshiageProguctTestMail4@gmail.com", 
      "qwertyuiop"
    );
    ...
    final project = Project(
      ...
      members: [], 
      donaters: [], 
      title: "毎朝会いたいからバス停広告作りましょう♡",
      discription: "", 
      deadline: Timestamp.fromDate(DateTime(2042, 11, 18)), 
      hashtags: ["idol", "韓流"],
      thumbnailUrl: "https://firebasestorage.googleapis.com/v0/b/oshikatsu-dev-8bb0d.appspot.com/o/PROJECT_IMAGE_STORAGE%2FE5HgSQRUYAMCnOW.jpg?alt=media&token=f2ccfbf1-00d0-4072-851f-df79f5a8f3bd", 
      moneyGoal: 120000,
      moneyDonated: 65000
    );
